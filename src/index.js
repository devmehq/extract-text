...
export function fromFileWithMimeAndPath(type, filePath, options, cb) {
  let called = false;
...
export function fromFileWithPath(filePath, options, cb) {
...
export function fromBufferWithMime(type, bufferContent, options, cb, withPath) {
  if (
    typeof type === 'string' &&
    bufferContent &&
...
export function fromBufferWithName(filePath, bufferContent, options, cb) {
  let type;
...
export function fromUrl(url, options, cb) {
